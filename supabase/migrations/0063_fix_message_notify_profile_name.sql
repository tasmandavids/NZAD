-- profiles.full_name is the canonical display name (no first_name/last_name columns).
-- Fix message insert trigger that failed with: column "first_name" does not exist
